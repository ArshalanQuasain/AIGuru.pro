...
function About() {
  ...
  return (
    <div className="mt-4 bg-white text-gray-800">
      {/* Hero Section */}
      <div className="text-center py-12">
        <h1 className="text-6xl font-semibold text-gray-700">AI Guru Solutions</h1>
        <h1 className="text-sm mb-6">Bridging Silicon Valley Innovation with Indian Excellence</h1>
      ...
      {/* Core Solutions */}
      <div className="py-12 bg-gray-100 px-4 sm:px:8 md:px-16">
        <h2 className="text-4xl font-semibold text-start md:text-start  text-gray-700 mb-8">Our Core Solutions:</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto ">
          <div className="p-6 bg-white shadow-lg rounded-lg border-2 border-black transform transition-transform hover:scale-105">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Custom AI Implementation</h3>
          ...
          <div className="p-6 bg-white shadow-lg rounded-lg border-2 border-black transform transition-transform hover:scale-105">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Industry-Specific Solutions</h3>
            <ul className="list-disc pl-5">
      ...
      <div className="bg-gray-100 py-12 px-4 sm:px:8 md:px-16">
        <h2 className="text-4xl font-semibold text-start md:text-start  text-gray-700 mb-8">Our Approach</h2>
        <div className="max-w-6xl m-8 text-lg">
      ...
      {/* Global Presence */}
      <div className="py-12 px-4 sm:px:8 md:px-16">
        <h2 className="text-4xl font-semibold text-start md:text-start  text-gray-700 mb-8">Global Presence, Local Understanding</h2>
      ...
      {/* Call to Action */}
      <div className="py-12 bg-gray-100 px-4 sm:px-8 md:px-16">
        <h2 className="text-4xl font-semibold text-start md:text-start text-gray-700 mb-8">Partner with Us</h2>
